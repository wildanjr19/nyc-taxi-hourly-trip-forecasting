"""
Script tahap 10: Hyperparameter tuning XGBoost-Advanced.
...
from src.features import ADVANCED_FEATURE_SET
from src.experiments.tuning_utils import run_xgb_tuning


def parse_args(argv: Optional[Sequence[str]] = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Tune XGBoost-Advanced with time series CV."
    )
...
def main(argv: Optional[Sequence[str]] = None) -> None:
    ...
    best = metadata["best"]
    print("Tuning XGBoost-Advanced selesai.")
